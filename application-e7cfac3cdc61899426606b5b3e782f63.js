    ...
    e.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (s) {
                ...
                o = "bottom" == o && a.top + a.height + l - c > f ? "top" : "top" == o && a.top - c - l < 0 ? "bottom" : "right" == o && a.right + r > d ? "left" : "left" == o && a.left - r < u ? "right" : o, i.removeClass(p).addClass(o)
            }
        ...
        if ("top" == e && h != s && (i = !0, t.top = t.top + s - h), /bottom|top/.test(e)) {
            var p = 0;
            t.left < 0 && (p = -2 * t.left, t.left = 0, o.offset(t), l = o[0].offsetWidth, h = o[0].offsetHeight), this.replaceArrow(p - n + l, l, "left")
